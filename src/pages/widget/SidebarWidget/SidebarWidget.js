        ...
        <div>
            <div className='bg-white py-[54px] h-screen flex flex-col space-y-[54px] min-w-[242px] px-[24px] border-[0.5px] border-[e6e6e6] ' >
                ...
                <ul className='flex flex-col space-y-[16px] '>
                    ...
                    <Link to="/admins">
                        <div className={`${href=== "http://localhost:3000/#/admins" || href==="http://localhost:3000/#/admins" ? "bg-[#E5F2FF] text-[#036]" : " text-[#808080] " } rounded-[2px]   flex items-center p-[8px] gap-[24px] `}>
                    ...
                    <Link to="/clock-in">
                        <div className={`${href=== "http://localhost:3000/#/clock-in" ? "bg-[#E5F2FF] text-[#036]" : " text-[#808080] " } rounded-[2px]  flex items-center p-[8px] gap-[24px] `}>
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
